...
> This journal for a few logs is written a couple days later because I often forgot to journal.
...
So today I thought that the PCB and Case where pretty much finished. so I decided to move onto the firmware.
